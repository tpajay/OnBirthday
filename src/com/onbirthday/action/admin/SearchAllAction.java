...
public class SearchAllAction extends Action
{
	...
	HttpSession session = request.getSession();
		...
		try{
			...
			String qry = "SELECT *,CONCAT(TRIM(SUBSTRING(details,1,30)), \"...\") as description,(case state when '' then '" + state +"' else state end) as elstate FROM restaurants ORDER BY state, city, name";
