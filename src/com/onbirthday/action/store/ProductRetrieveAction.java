...
public class ProductRetrieveAction extends Action
{
	...
	HttpSession session = request.getSession();
		...
		try{
			...
			String qry = "SELECT *,CONCAT(TRIM(SUBSTRING(details,1,30)), \"...\") as shortdetails FROM products where sku = '" + (String)values.get("sku") + "'";
